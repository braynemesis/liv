<template>
  <div class="home container-fluid d-flex d-md-block vh-100">
    <div class="row">
      <div class="col-1 vh-120 m-0 p-0 d-md-block d-none position-fixed">
        <div
          class="sidebar vh-120 d-flex align-items-center justify-content-center position-relative shadow"
        >
          <router-link to="/">
            <img
              src="@/assets/img/liv_vazada.png"
              alt="logo Liv"
      ...
      <div class="col-12 col-md-11 offset-md-1 vh-100 mb-5 position-relative px-0">
        ...
        >
          <button class="btn btn-white px-5" @click="previousRoute">
            Voltar
          </button>
          <button
          v-show="this.$route.name != 'Final'"
            class="btn btn-tertiary px-5 mr-md-2"
            style="height: 2.5rem"
            @click="nextRoute"
          >
            Próximo
